...
describe ('distance', () => {
    ...
    it ('should return last vector mapped on last path position', () => {
        ...
        expect(lastVector.projectedDistance)
            .to.be.approximately(lineDistance(path1, {units: 'meters'}), 0.000000000000001);
    ...
    it ('should return as many vectors as acquired path locations count (1)', () => {
        const vectors = classicPathDistance(path2, path1);
